...
const agentDirEnvName = "ZIKI_CODING_AGENT_DIR";
const startupBenchmarkEnvName = "ZIKI_STARTUP_BENCHMARK";
...
Options:
  ...
  --agent-dir <dir>      Use a specific ZIKI_CODING_AGENT_DIR for the benchmark run
  --isolated-agent-dir   Use a fresh temporary agent dir instead of the normal one
  --no-offline           Do not force ZIKI_OFFLINE=1 / ZIKI_SKIP_VERSION_CHECK=1

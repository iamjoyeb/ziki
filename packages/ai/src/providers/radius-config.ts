...
export const DEFAULT_RADIUS_GATEWAY = "https://radius.ziki.dev";
...
export function getRadiusModelsFromConfig(providerId: string, config: RadiusGatewayConfig): Model<"ziki-messages">[] {
...
export function getRadiusModels(providerId: string, credential: OAuthCredential | undefined): Model<"ziki-messages">[] {

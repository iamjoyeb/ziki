 ...
 *
 * Existing apps switch imports from "@iamjoyeb/ziki-ai" to
 * "@iamjoyeb/ziki-ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/ziki-messages.lazy.ts";
...
import { zikiMessagesApi } from "./api/ziki-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@iamjoyeb/ziki-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@iamjoyeb/ziki-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@iamjoyeb/ziki-ai/providers/all" or `Models.getProviders()`. */

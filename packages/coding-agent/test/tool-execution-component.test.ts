...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".ziki", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .ziki/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "Ziki documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {

...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@iamjoyeb/ziki-tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.ziki/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ziki/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.ziki/extensions",
				}),
			},
			{
				path: "/tmp/project/.ziki/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ziki/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.ziki/extensions",
			...
			{
				path: "/tmp/project/.ziki/npm/node_modules/ziki-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.ziki/npm/node_modules/ziki-markdown-preview/extensions/index.ts",
					{
						source: "npm:ziki-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.ziki/npm/node_modules/ziki-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.ziki/npm/node_modules/@scope/ziki-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ziki/npm/node_modules/@scope/ziki-scoped/extensions/index.ts", {
					source: "npm:@scope/ziki-scoped",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.ziki/npm/node_modules/@scope/ziki-scoped",
				}),
			},
			{
				path: "/tmp/project/.ziki/git/github.com/HazAT/ziki-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.ziki/git/github.com/HazAT/ziki-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/ziki-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.ziki/git/github.com/HazAT/ziki-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.ziki/git/github.com/HazAT/ziki-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.ziki/git/github.com/HazAT/ziki-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/ziki-interactive-subagents",
						scope: "project",
						origin: "package",
	...
	test("captures mixed extension layouts in compact output", () => {
		...
		expect(normalizeRenderedOutput(fakeThis.loadedResourcesContainer)).toMatchInlineSnapshot(`
			"[Extensions]
			  @scope/ziki-scoped, answer.ts, cli-extension.ts, HazAT/ziki-interactive-subagents, HazAT/ziki-interactive-subagents:subagents, local-index, user-index, ziki-markdown-preview"
		`);
	});
...
"[Extensions]
  main.ts"`);
	...
	test("package extensions still strip index.ts correctly (regression guard)", () => {
		...
		expect(normalizeRenderedOutput(fakeThis.loadedResourcesContainer)).toMatchInlineSnapshot(`
"[Extensions]
  ziki-markdown-preview"`);
	});

	test("labels npm sibling extensions relative to the declaring package", () => {
		const extensions: ExtensionFixture[] = [
			{
				path: "/tmp/project/.ziki/npm/node_modules/primary-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ziki/npm/node_modules/primary-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.ziki/npm/node_modules/primary-package",
				}),
			},
			{
				path: "/tmp/project/.ziki/npm/node_modules/sibling-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.ziki/npm/node_modules/sibling-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.ziki/npm/node_modules/primary-package",
...
"[Extensions]
  primary-package, primary-package:../sibling-package"`);
	...
	test("labels Windows npm sibling extensions relative to the declaring package", () => {
		const primaryPath = "C:\\Users\\me\\.ziki\\agent\\npm\\node_modules\\primary-package\\index.ts";
		const siblingPath = "C:\\Users\\me\\.ziki\\agent\\npm\\node_modules\\sibling-package\\index.ts";
		const baseDir = "C:\\Users\\me\\.ziki\\agent\\npm\\node_modules\\primary-package";
		const extensions: ExtensionFixture[] = [
			{
				path: primaryPath,
...
"[Extensions]
  project
    /tmp/project/.ziki/extensions/answer.ts
    /tmp/project/.ziki/extensions/local-index
    git:github.com/HazAT/ziki-interactive-subagents
      extensions
      extensions/subagents
    npm:@scope/ziki-scoped
      extensions
    npm:ziki-markdown-preview
      extensions
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		...
		const fakeThis = createShowLoadedResourcesThis({
			...
			cwd,
			contextFiles: [
				{ path: path.join(home, ".ziki", "agent", "AGENTS.md") },
		...
		expect(output).toContain("~/.ziki/agent/AGENTS.md, AGENTS.md");
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.ziki/agent/AGENTS.md");
		expect(output).toContain("~/Development/pi-mono/AGENTS.md");
		expect(output).not.toContain("~/.ziki/agent/AGENTS.md, AGENTS.md");
	});

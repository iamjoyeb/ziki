> ziki can create prompt templates. Ask it to build one for your workflow.
...
Ziki loads prompt templates from:

- Global: `~/.ziki/agent/prompts/*.md`
- Project: `.ziki/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `ziki.prompts` entries in `package.json`

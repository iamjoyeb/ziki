 ...
 *
 * Shows ziki.events for communication between extensions. One extension
...
export default function (ziki: ExtensionAPI) {
	...
	ziki.events.on("my:notification", (data) => {

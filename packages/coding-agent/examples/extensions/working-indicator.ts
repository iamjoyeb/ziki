 ...
 * working indicator shown while ziki is streaming a response.
 *
 * Usage:
 *   ziki --extension examples/extensions/working-indicator.ts
 *
 * Commands:
...
export default function (ziki: ExtensionAPI) {
	...
	ziki.registerCommand("working-indicator", {

...
Play DOOM as an overlay in ziki. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
ziki --extension ./examples/extensions/doom-overlay
```
...
- [ziki-doom](https://github.com/badlogic/ziki-doom) for the original ziki integration

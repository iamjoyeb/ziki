...
ziki --extension examples/extensions/permission-gate.ts

# Or copy to extensions directory for auto-discovery
cp permission-gate.ts ~/.ziki/agent/extensions/
```
...
| `send-user-message.ts` | Demonstrates `ziki.sendUserMessage()` for sending user messages from extensions |
...
| Extension | Description |
|-----------|-------------|
| `mac-system-theme.ts` | Syncs ziki theme with macOS dark/light mode |
...
| `event-bus.ts` | Inter-extension communication via `ziki.events` |

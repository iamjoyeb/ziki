import { ProcessTerminal, setKeybindings, TUI } from "@iamjoyeb/ziki-tui";
...
const OFFICIAL_PACKAGE_NAME = "@iamjoyeb/ziki-coding-agent";
const OFFICIAL_APP_NAME = "ziki";
const OFFICIAL_CONFIG_DIR_NAME = ".ziki";
 ...
 * - this is the official Ziki distribution (not a fork/rebrand)
 * - experimental features are enabled (ZIKI_EXPERIMENTAL=1)
